...
### TTL タイプ
 ...
 | ハブ                   | 双葉電子工業 | [BA2082 TB-RV71EH-7.4V/3W](https://www.futaba.co.jp/product/industrial_servo/command_type_servos/option_parts/relaybox_hub)                                                                                                                         | 1      | 類似型番に注意。末尾「3W」を使用。                                                                   |
 | USB アダプタ           | 双葉電子工業 | [00400070-1 CONVERTER RSC-U485 JPN](https://www.futaba.co.jp/product/industrial_servo/command_type_servos/rsc)                                                                                                                                      | 1      | TB-RV71EH-7.4V/3W とセットで使用（代用不可）                                                         |
...
TTL タイプと比べて RS-485 通信の安心感が増す一方で作業量が増えます。特に DF11 4ピンの配線を間違えると悲惨で危険なことになるかもしれません。
 ...
 - ハブを[「BA2083 TB-EH31DF-100 もしくは BA2084 TB-EH31DF-200」と「BA2085 TB DF31DF-100」](https://www.futaba.co.jp/product/industrial_servo/command_type_servos/option_parts/relaybox_hub) の２個セットに変更
 - 電源ケーブル（ハブ側）は削除
 ...
 | ハブ（根元側）      | 双葉電子工業 | [BA2083 TB-EH31DF-100 もしくは BA2084 TB-EH31DF-200](https://www.futaba.co.jp/product/industrial_servo/command_type_servos/option_parts/relaybox_hub)                                                                                  | 1      | コネクタを自分で帳尻合わせするなら、創設側と同じ [BA2085 TB DF31DF-100](https://www.futaba.co.jp/product/industrial_servo/command_type_servos/option_parts/relaybox_hub) でも可 |
 | ハブ（増設側）      | 双葉電子工業 | [BA2085 TB DF31DF-100](https://www.futaba.co.jp/product/industrial_servo/command_type_servos/option_parts/relaybox_hub)                                                                                                                | 1      |                                                                                                                                                                                 |
 ...
 | DF11 ４ピンコネクタ | ヒロセ電機   | [DF11-4DS-2C](https://www.hirose.com/ja/product/document?clcode=&productname=&series=DF11&documenttype=Catalog&lang=ja&documentid=jd_DF11_CAT)                                                                                         | 1      | 電源供給ケーブル用。ターミネート抵抗を挿すなら１個追加。                                                                                                                        |
 | DF11用コンタク      | ヒロセ電機   | [(適宜)](https://www.hirose.com/ja/product/document?clcode=&productname=&series=DF11&documenttype=Catalog&lang=ja&documentid=jd_DF11_CAT)                                                                                              | 2      | 同上（ターミネート抵抗を挿すなら２個追加）                                                                                                                                      |
 | モータ電源          | (適宜)       | (適宜)                                                                                                                                                                                                                                 | 1      | サーボモジュールは 4.8〜7.2[V] が定格、電流容量は不明                                                                                                                           |
 | 電源ケーブル        | 自作         | (適宜)                                                                                                                                                                                                                                 |        |                                                                                                                                                                                 |
 | タッピングネジ      | (適宜)       | (M2 タッピング 10mm)                                                                                                                                                                                                                   | 34     |                                                                                                                                                                                 |
 | 両面テープ          | (適宜)       | (薄手のもの)                                                                                                                                                                                                                           | (適宜) | サーボモジュールとリンク部材との固定は両面テープ                                                                                                                                |
 | リンク部材          | (適宜)       | (step ディレクトリ内のを 3D プリント)                                                                                                                                                                                                  | 各1    |                                                                                                                                                                                 |
...
注意事項
 - ターミネート抵抗を RS-485 配線の両端に入れると安心できるかもしれません。
...
RSC-U485 は FTDI のドライバ (ftdi_sio) で動きますが、標準の FTDI のドライバには RSC-U485 が登録されていません。手動でその場で動くようにするには以下のコマンドを実行してください。
...
多分、ドライバを[Futaba のサイト](https://www.futaba.co.jp/product/industrial_servo/command_type_servos/robot_download/software) からダウンロードしてインストールして、どの COM ポートに割り当てられたか調べて、dicot でその COM ポートを指定すれば動くのではないか、と思います。
...
## このリポジトリについて
 ...
 | step/*                                    | リンク部材の STEP ファイル (ros2_control で動かすのには不要)                                                                 |
 | pics/*                                    | 組み立て中の写真 (ros2_control で動かすのには不要)                                                                          |
...
│   ...
├── step
│   ├── FCS4HAND2310_BASE.STEP
│   ├── FCS4HAND2310_BASE_LID.STEP
│   ...
├── scripts
│   ├── set_angles.py
│   ├── torque_enable.sh
